var options = {
  ...
  function Ball() {
    ...
    this.r = options.ballBaseRadius  + Math.floor(Math.random() * options.ballVariantRadius);
    this.speed = options.ballBaseSpeed + Math.floor(Math.random() * options.ballVariantSpeed);
